  ...
  <br><br><br>
	...
	<form method="post" role="form" id="loginform" class="form-horizontal form-material" action="<?php echo base_url();?>login/validate_login">
       ...
       <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-controll" type="email" name="email" required="" placeholder="<?php echo get_phrase('email');?>" style="width:100%">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12" >
                            <input class="form-controll" type="password" name="password" required="" placeholder="<?php echo get_phrase('passord');?>" style="width:100%">
                        </div>
                    </div>
