 <!--row -->
            <div class="row">
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('New Patient');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('OPD Patient');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    ...
                                    <span class="text-muted"><?php echo get_phrase('Todays Operations');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                <i class="fa fa-inr" aria-hidden="true" style="background: #036c86"></i>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="panel panel-info">
                            ...
                            <h3 class="box-title m-b-0"><?php echo get_phrase('Recently Added Teachers');?></h3></div>

                            <div class="panel-body table-responsive">
                                <table id="example01" class="table table-striped" cellspacing="0" width="100%">
