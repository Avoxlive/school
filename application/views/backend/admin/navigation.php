    ...
    <div class="navbar-default sidebar" role="navigation">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    <li class="user-pro" style="background-image:url('<?php echo base_url();?>/uploads/user-bg01.jpg')">
                    ...
                    <img src="<?php echo base_url() . $face_file;?>" alt="user-img" class="img-circle"> <span class="hide-menu">
                       ...
                       <?php 
                        ...
                        <ul class="nav nav-second-level" style="background:#22889a;">
    ...
    <!---  Permission for Admin Dashboard ends here ------>
     ...
     <?php if($check_admin_permission == '1'):?>   
        <li> <a href="javascript:void(0);" class=""><i class="fa fa-mortar-board" data-icon="7"></i> <span class="hide-menu"> <?php echo get_phrase('Appointment');?> <span class="fa arrow"></span></span></a>
