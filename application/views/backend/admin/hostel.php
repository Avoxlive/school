<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading">
				<?php echo get_phrase('New Hostel');?>
	<div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;Add <?php echo get_phrase('New Hostel');?> here<i class="btn btn-primary btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div></div>
    <div class="panel-wrapper collapse out" aria-expanded="true">
                    ...
                    <div class="form-group">
                 	<label class="col-md-12" for="example-text"><?php echo get_phrase ('Document');?>(hostel CV or any document)</label>
                    <div class="col-sm-12">
...
<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_hostels');?></div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img src="<?php echo  $this->crud_model->get_image_url('hostel', $hostel['hostel_id']) ;?>" class="img-circle" width="30" height="30"></td>
                            ...
                            <a href="<?php echo base_url() . 'uploads/hostel_image/' . $hostel['file_name'];?>"><button class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></button>
                            </td>
                        </tr>
                    <?php endforeach;?>
                    </tbody>
