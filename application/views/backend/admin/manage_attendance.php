...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('Attendance');?>
            </div>
            <div class="panel-body table-responsive">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for="example-text"><?php echo get_phrase('section');?></label>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control datepicker" id="example-date-input" name="timestamp"
                                data-format="dd-mm-yyyy" value="<?php echo $date."-".$month."-".$year ;?>" required>
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-info btn-sm"><i class="fa fa-search"></i>&nbsp;<?php echo get_phrase('get_student');?></button>
					</div>
    ...
    <div class="col-sm-12">
        <div class="panel panel-info">
            <div class="panel-body table-responsive">
                ...
                <form
                    action="<?php echo base_url();?>admin/manage_attendance/<?php echo $date.'/'.$month.'/'.$year.'/'.$class_id.'/'.$section_id;?>"
                    ...
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                          ...
                          foreach($students as $key => $student){?>
                            ...
                            <tr class="gradeA">
                                <td><?php echo $i?></td>
                                <td><img src="<?php echo $this->crud_model->get_image_url('student', $student['student_id']);?>"
                                        class="img-circle" style="max-height:30px; margine-right:30px;"></td>
                            ...
                            ?>
                                    ...
                                    <select name="status_<?php echo $student['student_id'];?>"
                                        ...
                                        <option value="0" <?php if($status == 0) echo 'selected="selected"';?>>Undefined
                                        </option>
                                        ...
                                        <option value="3" <?php if($status == 3) echo 'selected="selected"';?>>Late
                                        </option>
                                        <option value="4" <?php if($status == 4) echo 'selected="selected"';?>>Half Day
                                        </option>
